 ...
 * @author harish
 */
public class intrcamps extends javax.swing.JFrame {

    /**
     * Creates new form intrcamps
     */
    static String currentuser =null;
    public intrcamps(String s) {
        initComponents();
        currentuser = s; 
    }
    ...
    private void initComponents() {
        ...
        bookic1 = new javax.swing.JButton();
        bookic2 = new javax.swing.JButton();
        ...
        jTextArea1.setText("\t\t Austria\nA spectacular Summer Camp mountain and lakeside \nexperience in Austria.\nAmount - Rs. 250k /- ");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(120, 240, 360, 115);
        ...
        jTextArea2.setText("\t         Switzerland\nA truly international Summer Camp environment in the \nheart of the Swiss Alps.\nAmount - Rs 300k/-");
        jScrollPane2.setViewportView(jTextArea2);

        getContentPane().add(jScrollPane2);
        jScrollPane2.setBounds(170, 600, 400, 100);

        bookic1.setBackground(java.awt.Color.cyan);
        bookic1.setFont(new java.awt.Font("URW Gothic L", 1, 15)); // NOI18N
        bookic1.setText("BOOK");
        bookic1.setOpaque(true);
        bookic1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                bookic1MouseClicked(evt);
            }
        });
        bookic1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bookic1ActionPerformed(evt);
            }
        });
        getContentPane().add(bookic1);
        bookic1.setBounds(290, 360, 90, 28);

        bookic2.setBackground(java.awt.Color.cyan);
        bookic2.setFont(new java.awt.Font("URW Gothic L", 1, 15)); // NOI18N
        bookic2.setText("BOOK");
        bookic2.setOpaque(true);
        bookic2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                bookic2MouseClicked(evt);
            }
        });
        getContentPane().add(bookic2);
        bookic2.setBounds(330, 700, 90, 28);

        jLabel1.setBackground(java.awt.Color.cyan);
        jLabel1.setFont(new java.awt.Font("URW Chancery L", 1, 50)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("INTERNATIONAL CAMPS");
        jLabel1.setOpaque(true);
        getContentPane().add(jLabel1);
        jLabel1.setBounds(250, 0, 680, 71);

        jLabel2.setIcon(new javax.swing.ImageIcon("/home/harish/project/austria.jpg")); // NOI18N
        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(290, 160, 550, 370);

        jLabel3.setIcon(new javax.swing.ImageIcon("/home/harish/project/swissalps.jpg")); // NOI18N
        jLabel3.setText("jLabel3");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(-10, 0, 1190, 880);
    ...
    private void bookic1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookic1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_bookic1ActionPerformed

    private void bookic1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bookic1MouseClicked
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_bookic1MouseClicked

    private void bookic2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bookic2MouseClicked
        // TODO add your handling code here:
        Connection conn = null;
            PreparedStatement pstmt = null;
            Statement stmt = null;
    ...
    }//GEN-LAST:event_bookic2MouseClicked
   ...
   private void jMenu4MouseClicked(java.awt.event.MouseEvent evt) {                                    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(intrcamps.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton bookic1;
    private javax.swing.JButton bookic2;
